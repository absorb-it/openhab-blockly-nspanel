uid: absorb-it:blockly:nspanel_helpers
tags: []
props:
  parameters: []
  parameterGroups: []
timestamp: Nov 28, 2023, 11:43:45 AM
component: BlockLibrary
config:
  name: NSPanel Helpers
slots:
  blocks:
    - component: BlockType
      config:
        args0:
          - name: ICON_NAME
            ...
            check: String
        colour: 90
        helpUrl: "https://docs.nspanel.pky.eu/icon-cheatsheet.html"
        message0: get icon for icon-name %1
        output: String
        tooltip: >
          "Converts the name of some icon to the icon code. Check the help link for a list of names. Converted from https://github.com/joBr99/nspanel-lovelace-ui/blob/main/apps/nspanel-lovelace-ui/luibackend/icon_mapping.py"
        type: absorb_it_nspanel_getIcon
      slots:
        code:
          - component: BlockCodeTemplate
            config:
              template: >-
                {{utility:absorb_it_nspanel_getIcon}}({{input:ICON_NAME}})
        toolbox:
          - component: PresetInput
            config:
              fields:
                TEXT: home-alert-outline
              name: ICON_NAME
              shadow: true
              type: text
    - component: BlockType
      config:
        args0:
          - name: WEATHER_CODE
            ...
            check: String
        colour: 90
        helpUrl: "https://github.com/sevesalm/eInk-weather-display/blob/master/weather_icon_codes.md"
        inputsInline: false
        message0: get icon name for WeatherSymbol3 code %1
        output: String
        tooltip: "Converts Weathercode from FMI forcast to suitable Icon-Name."
        type: absorb_it_nspanel_weatherIcon
      slots:
        code:
          - component: BlockCodeTemplate
            config:
              template: >
                {{utility:absorb_it_nspanel_convertWeatherCodeToIcon}}({{input:WEATHER_CODE}})
        toolbox:
          - component: PresetInput
            config:
              fields:
    ...
    - component: BlockType
      config:
        ...
        helpUrl: ""
        inputsInline: false
        message0: NAVIGATION string %1 Icon %3 Icon Color %4 Target Script Id %2
        output: nspanel_navigationString
        tooltip: "Generates Navigation Items, usually found on top left and top right of any page. The Navigation should point to some Target Script by using it's Id. Therefore it might make sense to use meaningful script names for the display pages."
        type: absorb_it_nspanel_navigation
      slots:
        code:
          - component: BlockCodeTemplate
            config:
              template: >-
                {{utility:absorb_it_nspanel_getNavString}}({{input:INT_NAME_ENTITY}}, {{input:ICON}}, {{input:ICON_COLOR}})
        toolbox:
          - component: PresetInput
            config:
              fields:
                TEXT: id (of the rule or script to call)
              name: INT_NAME_ENTITY
              shadow: true
              type: text
          - component: PresetInput
    ...
    - component: BlockType
      config:
        ...
        colour: 90
        helpUrl: "https://docs.nspanel.pky.eu/card-climate/"
        inputsInline: false
        message0: >
          HVAC BUTTON string %1 Icon %2 Icon Color %3 State of Item ([0,1]) %4 Button Press Action %5
        output: nspanel_hvacButtonString
        tooltip: "Special Button which can be used with the Thermo Page. The Button-Press action will be triggered without any useful parameter."
        type: absorb_it_nspanel_hvacButton
      slots:
        code:
          - component: BlockCodeTemplate
            config:
              template: >-
                {{utility:absorb_it_nspanel_getHVACButtonString}}({{input:ICON}}, {{input:ICON_COLOR}}, {{input:GETTER}}, `{{statements:SETTER}}`)
        toolbox:
          - component: PresetInput
            config:
              fields:
      ...
      config:
        args0:
          ...
          - name: SETTER
            type: input_statement
        colour: 90
        helpUrl: "https://docs.nspanel.pky.eu/card-alarm/"
        inputsInline: false
        message0: >
          ALARM BUTTON string %1 Display Name %2 Buttonpress Action %3 (returnValue == CODE) %4 %5
        output: nspanel_alarmBtnString
        tooltip: "Labeled Button to be used with the Alarm Page. If pressed, the Buttonpress Action is called with the Variable 'returnValue' holding the entered pin-code."
        type: absorb_it_nspanel_alarmButton
      slots:
        code:
          - component: BlockCodeTemplate
            config:
              template: >-
                {{utility:absorb_it_nspanel_getAlarmButtonString}}({{input:DISPLAY_NAME}}, `{{statements:SETTER}}`)
        toolbox:
          - component: PresetInput
            config:
              fields:
              ...
              <block type="logic_compare">
                ...
                <value name="A">
                  <block type="oh_getitem_state">
                    <value name="itemName">
                      <block type="oh_item">
                        <field name="itemName">myItem</field>
                      </block>
                    </value>
                  </block>
                </value>
  ...
  utilities:
    - component: UtilityFunction
      config:
        ...
        name: absorb_it_nspanel_helpers_getRGB565
    - component: UtilityFunction
      config:
        code: >-
        ...
        name: absorb_it_nspanel_helpers_checkParam
    - component: UtilityFunction
      config:
        code: >-
        ...
        name: absorb_it_nspanel_helpers_safeEval
    - component: UtilityFunction
      config:
        code: >-
          function {{name}}() {
        ...
        name: absorb_it_nspanel_helpers_getEntityPos
    - component: UtilityFunction
      config:
        code: >-
          function {{name}}(icon, iconColor, getState, setState) {
        ...
        name: absorb_it_nspanel_getHVACButtonString
    - component: UtilityFunction
      config:
        code: >-
          function {{name}}(intNameEntity, icon, iconColor) {
            return {
              "sendNow": "1",
        ...
        name: absorb_it_nspanel_getNavString
    - component: UtilityFunction
      config:
        code: >-
          function {{name}}(displayName, setter) {
            var ownEntityPos = {{absorb_it_nspanel_helpers_getEntityPos}}();
            if (ctx.item == ownEntityPos) {
              if (ctx.request == 'pageUpdate') {
                {{absorb_it_nspanel_helpers_safeEval}}(setter, ctx.newState);
                return { "refreshPage": "1" };
              }
            }
            return {
              "resultString": {{absorb_it_nspanel_helpers_checkParam}}(displayName, 1) + {{absorb_it_nspanel_helpers_checkParam}}('item?' + ownEntityPos, 1)
            }
          }
        name: absorb_it_nspanel_getAlarmButtonString
    - component: UtilityFunction
      config:
        code: >-
          function {{name}}(code) {
      ...
      config:
        code: >-
          function {{name}}(iconname) {
            // adapted from https://github.com/joBr99/nspanel-lovelace-ui/blob/main/apps/nspanel-lovelace-ui/luibackend/icon_mapping.py
        ...
        name: absorb_it_nspanel_getIcon
