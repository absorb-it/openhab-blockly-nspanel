...
- [setTimerAction](blockLibrary_nspanel_helpers_setTimerAction.md)
- [getTimerString](blockLibrary_nspanel_helpers_getTimerString.md)
- [startTimer](blockLibrary_nspanel_helpers_startTimer.md)
- [stopTimer](blockLibrary_nspanel_helpers_stopTimer.md)
- [setTimerNewTime](blockLibrary_nspanel_helpers_setTimerNewTime.md)
- [getTimerStatus](blockLibrary_nspanel_helpers_getTimerStatus.md)
